...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinx-jsonschema-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12536&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinx-jsonschema-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinx-jsonschema` can be installed with:

```
conda install sphinx-jsonschema
```

It is possible to list all of the versions of `sphinx-jsonschema` available on your platform with:
